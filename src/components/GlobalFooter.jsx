...
const GlobalFooter = () => {
  return (
    <footer className="d-flex  mt-auto py-5 text-center bg-dark text-white bg-opacity-10">
      <div className="container border-top border-secondary border-opacity-25 pt-5">
        ...
        <div className="small opacity-50 mb-4 d-flex align-items-center justify-content-center gap-2">
        ...
        <div className="mx-auto my-4" style={{ height: '1px', width: '60px', background: 'linear-gradient(to right, transparent, #ff9800, transparent)' }}></div>
