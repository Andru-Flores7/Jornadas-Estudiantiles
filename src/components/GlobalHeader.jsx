      ...
      <div className="container-fluid d-flex justify-content-between align-items-center">
        ...
        <div className="text-center flex-grow-1">
          <h2 className="m-0 fw-bold text-uppercase tracking-tighter" style={{ fontSize: '1.25rem', letterSpacing: '1.5px' }}>
            <span className="text-white">Jornadas</span>{' '}
            <span style={{ color: '#ba8b02' }}>Estudiantiles</span>{' '}
            <span className="text-white opacity-75">2026</span>
          </h2>
        </div>

        {/* Logo Derecho (Espacio Reservado) */}
